...
namespace RojgarMantra
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<ApplicationUser>(context.Get<Data.ApplicationDbContext>()));
        ...
        internal Task<ApplicationUser> FindByIdAsync(int countryID)
        {
