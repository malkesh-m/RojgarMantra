var StateIndex = {
    ...
    init: function () {
        ...
        $('#BtnAddJob').click(function () {
            StateIndex.showAddEditModal(StateIndex.refresh, undefined);
        });
            ...
            "columns": [
                {
                    ...
                    "render": function (data, type, row) {
                        return "<a href='/State/AddEdit?Id=" + row.Id + "'  title='Edit'><i class='si si-pencil text-primary mr-2' data-toggle='tooltip' title='' data-placement='top' data-original-title='Edit'></i></a> &nbsp <a href='#' onclick='StateIndex.delete(\"" + row.Id + "\")'" + row.Id + "' title='Delete'><i class='si si-trash text-danger mr-2' data-toggle='tooltip' title='' data-placement='top' data-original-title='Delete'></i></a>"
                    }
                },
